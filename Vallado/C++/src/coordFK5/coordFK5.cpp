...
* --------------------------------------------------------------------------- */
		...
		)
	{
		...
		// ------------------------  implementation   -------------------
		convrt = 0.0001 * M_PI / (180 * 3600.0); 	// 0.0001" to rad
...
* --------------------------------------------------------------------------- */
		...
		)
	{
		...
		if (iauhelp == 'y')
		{
			printf("fa %11.7f  %11.7f  %11.7f  %11.7f  %11.7f deg \n", l * 180 / M_PI, l1 * 180 / M_PI, f * 180 / M_PI, d * 180 / M_PI, omega * 180 / M_PI);
			printf("fa %11.7f  %11.7f  %11.7f  %11.7f deg \n", lonmer * 180 / M_PI, lonven * 180 / M_PI, lonear * 180 / M_PI, lonmar * 180 / M_PI);
			printf("fa %11.7f  %11.7f  %11.7f  %11.7f deg \n", lonjup * 180 / M_PI, lonsat * 180 / M_PI, lonurn * 180 / M_PI, lonnep * 180 / M_PI);
			printf("fa %11.7f  \n", precrate * 180 / M_PI);
		}
	}  // procedure fundarg
...
* --------------------------------------------------------------------------- */
		...
		)
	{
		...
		if (iauhelp == 'y')
		{
			printf("pr %11.7f  %11.7f  %11.7f %11.7fdeg \n", psia * 180 / M_PI, wa * 180 / M_PI, epsa * 180 / M_PI, chia * 180 / M_PI);
			printf("pr %11.7f  %11.7f  %11.7fdeg \n", zeta * 180 / M_PI, theta * 180 / M_PI, z * 180 / M_PI);
		}
	} // procedure precess
...
* --------------------------------------------------------------------------- */
    ...
    double twopi = M_PI * 2;
		...
		if (iauhelp == 'y')
			printf("meaneps %11.7f dp  %11.7f de  %11.7f te  %11.7f  \n", meaneps * 180 / M_PI, deltapsi * 180 / M_PI, deltaeps * 180 / M_PI, trueeps * 180 / M_PI);
	}  // procedure nutation
...
* --------------------------------------------------------------------------- */
		...
		)
	{
		...
		{
			ast = gmst + deltapsi *  cos(meaneps) + 0.00264 * M_PI / (3600 * 180) * sin(omega)
				+ 0.000063 * M_PI / (3600 * 180) * sin(2.0  * omega);
		}
		else
			ast = gmst + deltapsi *  cos(meaneps);

		ast = fmod(ast, 2.0 * M_PI);
		...
		if (iauhelp == 'y')
			printf("st gmst %11.7f ast %11.7f ome  %11.7f \n", gmst * 180 / M_PI, ast * 180 / M_PI, omegaearth * 180 / M_PI);
...
* --------------------------------------------------------------------------- */
		...
		)
	{
		...
		else
		{
			...
			sp = -47.0e-6 * ttt * M_PI / (180.0 * 3600.0);
			cossp = cos(sp);
			sinsp = sin(sp);
...
* ----------------------------------------------------------------------------*/
		...
		)
	{
		...
		{
			gmstg = gmst
				+ 0.00264*M_PI / (3600.0 * 180.0)*sin(omega)
				+ 0.000063*M_PI / (3600.0 * 180.0)*sin(2.0 *omega);
		}
		else
			gmstg = gmst;
